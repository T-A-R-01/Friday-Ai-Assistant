...
from rich import print  # Import the rich library for pretty printing
...
ChatHistory = [
    ...
    {"role": "User", "message": "what is today's date and by the way remind me that i have a meeting at 9:00pm."},
    {"role": "Chatbot", "message": "general what is today's date, reminder 9:00pm meeting."},
...
def FirstLayerDMM(prompt: str = "test"):
    ...
    stream = co.chat_stream(
        ...
        chat_history=ChatHistory,  # pass the predefined chat history for context.
        prompt_truncation='OFF',  # Ensure that the prompt is not truncated.
    ...
    if "(query)" in response:
        newresponse = FirstLayerDMM(prompt=prompt)  # type: ignore
